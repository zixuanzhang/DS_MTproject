...
auc <- c(roc.rpart$auc[1], roc.rpartc$auc[1], roc.bag$auc[1], roc.rf$auc[1], roc.gbmB$auc[1], roc.gbmA$auc[1],
         roc.glm$auc[1], roc.glmn$auc[1], roc.lda$auc[1], roc.qda$auc[1], roc.nb$auc[1])
modelNames <- c("rpart","ctree","bag","rf","gbmB","gbmA", "glm", "glmnet", "lda", "qda", "nb") 
legend("bottomright", legend = paste0(modelNames, ": ", round(auc,3)), col = 1:11, lwd = 2)
```
